...
- (NSArray *)viewControllersToDisplayInInfiniteTabBarController:(M13InfiniteTabBarController *)controller
{
    ...
    vc1.imageView.image = [[UIImage imageNamed:@"BookmarksIcon"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    vc1.imageView.tintColor = [UIColor colorWithHue:0 saturation:0.92 brightness:0.75 alpha:1];
    ...
    vc2.imageView.image = [[UIImage imageNamed:@"CloudIcon"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    vc2.imageView.tintColor = [UIColor colorWithHue:0.07 saturation:0.82 brightness:0.86 alpha:1];
    ...
    vc3.imageView.image = [[UIImage imageNamed:@"DownloadIcon"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    vc3.imageView.tintColor = [UIColor colorWithHue:0.37 saturation:0.95 brightness:0.5 alpha:1];
    ...
    vc4.imageView.image = [[UIImage imageNamed:@"FavoritesIcon"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];\
    vc4.imageView.tintColor = [UIColor colorWithHue:0.46 saturation:1 brightness:0.7 alpha:1];
    ...
    vc5.imageView.image = [[UIImage imageNamed:@"HistoryIcon"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    vc5.imageView.tintColor = [UIColor colorWithHue:0.63 saturation:0.82 brightness:0.78 alpha:1];
    ...
    vc6.imageView.image = [[UIImage imageNamed:@"SearchIcon"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    vc6.imageView.tintColor = [UIColor colorWithHue:0.92 saturation:0.83 brightness:0.82 alpha:1];
